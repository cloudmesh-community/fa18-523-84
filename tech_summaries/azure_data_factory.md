...
Every day bilions of gigabytes of data are generated. [@fa18-523-84-bbc-azure-data-factory]  In the age of Big Data companies need a way to process and orgaize the data that is generated by their applications.  According to Microsoft Azure Data Factory is a "cloud-based data integration service that allows you to create data-driven workflows in the cloud for orchestrating and automating data movement and data transformation." [] 
